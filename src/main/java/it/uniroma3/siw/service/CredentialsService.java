...
public class CredentialsService {
    ...
    public Credentials saveCredentials(Credentials credentials) {
        ...
        // Utile per non ri-codificare una password già codificata durante un aggiornamento.
    ...
    /**
     * Trova le credenziali tramite il loro ID.
     * Restituisce un Optional per gestire in modo sicuro il caso in cui non vengano trovate.
     */
    ...
    /**
     * Trova le credenziali tramite l'email (che funge da username).
     * Restituisce un Optional per una gestione più sicura.
     */
    ...
    /**
     * Verifica se esistono credenziali associate a una data email.
     * Fondamentale per la logica di registrazione per evitare duplicati.
     */
    ...
    public boolean isAdminLogged(Authentication auth) {
        ...
        return auth.getAuthorities().stream()
                   .anyMatch(a -> a.getAuthority().equals("ROLE_" + Credentials.ADMIN_ROLE));
    }
}